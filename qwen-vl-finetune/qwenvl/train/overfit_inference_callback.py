...
class OverfitInferenceCallback(TrainerCallback):
    ...
    def __init__(self, inference_frequency=5, data_path=None, output_dir=None, processor=None):
        """
        Args:
            ...
            processor: The processor/tokenizer to use for inference
        """
    ...
    def on_epoch_end(self, args, state, control, model, **kwargs):
        ...
        # Skip inference callback in distributed training to avoid NCCL timeout
        # (Inference can take a long time while other ranks wait)
