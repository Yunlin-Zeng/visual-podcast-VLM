...
# Model configuration - TEST WITH 8B
MODEL_PATH="/home/ubuntu/LLM/qwen3-vl-8b"

# Dataset configuration - USING OLD DATASET THAT WORKED
DATASET="podcast_qwen_lora%100"  # Use 199 samples that worked before

# Output configuration with date
DATE=$(date +%Y-%m-%d)
RUN_NAME="qwen3vl-8b-test-same-config"
...
NUM_EPOCHS=1        # Just test 1 epoch first
